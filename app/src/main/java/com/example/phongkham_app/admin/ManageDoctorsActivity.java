...
public class ManageDoctorsActivity extends AppCompatActivity {
    ...
    private void loadDoctors() {
        // Dữ liệu mẫu (sử dụng constructor đầy đủ của Doctor tập trung)
        doctorList.add(new Doctor("1", "BS. Nguyễn Văn A", "Tim mạch", "0901234567", 4.8, 120, R.drawable.doctor, true));
        doctorList.add(new Doctor("2", "BS. Trần Thị B", "Nội khoa", "0902345678", 4.5, 85, R.drawable.doctor, false));
        doctorList.add(new Doctor("3", "BS. Lê Văn C", "Ngoại khoa", "0903456789", 4.9, 200, R.drawable.doctor, true));
        doctorList.add(new Doctor("4", "BS. Phạm Thị D", "Nhi khoa", "0904567890", 4.7, 150, R.drawable.doctor, false));
        doctorList.add(new Doctor("5", "BS. Hoàng Văn E", "Da liễu", "0905678901", 4.6, 90, R.drawable.doctor, false));
