...
public class ProfilePatient extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnMedicalRecord.setOnClickListener(v -> {
            Intent updateIntent = new Intent(ProfilePatient.this, UpdateRecordActivity.class);
            updateIntent.putExtra("customerId", getIntent().getIntExtra("patientId", 1));
            updateIntent.putExtra("appointmentId", 1); // Mock cho mockup
            updateIntent.putExtra("doctorId", 1); 
