...
public class ManageServicesActivity extends AppCompatActivity {
    ...
    private com.example.phongkham_app.data.repository.ServiceRepository serviceRepository;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        serviceRepository = com.example.phongkham_app.data.repository.ServiceRepository.getInstance(getApplication());
    ...
    private void loadServices() {
        ...
        if (serviceRepository != null) {
            serviceList.addAll(serviceRepository.getServices());
        }
        filteredList.clear();
